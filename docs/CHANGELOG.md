...
Dated history of fixes and features for the Tinker whole-robot simulation
deployment. Newest entries first. Root-cause investigation narratives (what
was measured, what was ruled out) live in [`developer-log.md`](developer-log.md)
instead of here.
