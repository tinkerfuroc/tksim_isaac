...
class Task8OMPLOverlayProvenanceTest(unittest.TestCase):
    ...
    def test_contract_scenario_identities_recomputed(self) -> None:
        ...
        expected = {
            "qualification-moveit-plan-joint": {
                "decl": "13321df8c583a316ddf3ff75ba7aadefb29ad4c6fe865e8450d322bb4344edad",
                "rev": "2026-08-01-moveit-qualification-joint",
                "rev_digest": "77b26bb8bc35649f5b25e95c2d4a56c30cf6933d918a8419d956b1ca987d0510",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "bd9cf605a448f1baac8140a98ce9453bccc4bd41b64c6b6e27f6fb6ffca3b247",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-plan-pose": {
                "decl": "8ebdd2b6719e0d2ad73b605301e572631556bc91ead1986a30b5076fed69a614",
                "rev": "2026-08-08-moveit-qualification-pose",
                "rev_digest": "eff9ec73877e80ab8221a6817ec91b0d18496f388c815259282002e89eddd065",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "91a4cbe9e7c87975e458b2bfae691e53eab39298a1a41abea053005c1e697821",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-execute-joint": {
                "decl": "7262a48a4ae07472ca09378ac98b1a881a35209ee259a1cad3417ab8c97a48da",
                "rev": "2026-08-02-moveit-execute-joint",
                "rev_digest": "f628dc1d9ad8de424ee27c53e219fbab92135ab0e567d6cc29f09eb421482d5f",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "dedf927f2fad84671c2a537427f6aca235e57568c24ea5db437117e446cd8425",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-execute-pose": {
                "decl": "be4aa4103dc7a3a8dd521221738dbec97c4190df3246b74644cf8a9508a35105",
                "rev": "2026-08-02-moveit-execute-pose",
                "rev_digest": "7604bcdcfd96d18b3430f0103719ec8228a29121567f57545658b34ab4f0168f",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "296295b7fb607ea56d05f3bd2769c0cbd8d3806e5206d0fcf0d797d6e59861ca",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-cartesian-retreat": {
                "decl": "779ed5bfee4d99ac3181ae035174823e840fd71f91118eca6087b44ae074eded",
                "rev": "2026-08-02-moveit-execute-cartesian-retreat",
                "rev_digest": "e872d2344ee5b060861e235b6b43bd937b29621a5a1607b483954c600dd16e5c",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "1b871950373d1fb887c709a38d2269656224d0d04bb30bd89a280c77cafda997",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-gripper": {
                "decl": "5e744b0a9e43e27cb2e2abb0cc7527a4f76c16af1352b6aa8e74fef94ba55516",
                "rev": "2026-08-02-moveit-execute-gripper",
                "rev_digest": "8759d2f50431a8945ccd93b0895facb874914ccff89ce3f43167a3536d5444e4",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "ca713c81e66fc1fcdab561c1d01900cabe9708dc17f498bbfe4d99e5a764c5e0",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-cancel": {
                "decl": "99b4ef8e4aeef8850900cf18aa8ea254fabd43dbadcc4b320f074bd0393ca9fa",
                "rev": "2026-08-02-moveit-execute-cancel",
                "rev_digest": "644b6116fbbefc3470e62a914c5b770d39c5fb22991b537f465d8cd64c6e001c",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "cff2d11d21fc56022d5b14b280dfdc4ad769c86af699639dd8bbd95a189cc909",
                "target": "sim_fixture/public_target",
            },
            "qualification-moveit-safety": {
                "decl": "701ead89c5d13c6a9202af0499a69f8fca36f07f6acf8f4624cec9300ab6b8b9",
                "rev": "2026-08-02-moveit-execute-safety",
                "rev_digest": "80739d42bd7544bdb6c491d90d792bab4050264f3c708c6d7a094e25dca43400",
                "owned": ["sim_fixture/pedestal", "sim_fixture/public_target"],
                "fd": "53eeaee2300b518e2eac3f4120d6d085ac5b5267d4a690249dc4efad9f397169",
                "target": "sim_fixture/public_target",
            },
            "qualification-pick-place-positive": {
                "decl": "571f1ae0b14d64439d6304199e611855af47bb5a3270d362e3fe89913cf69e21",
                "rev": "qualification-v1",
                "rev_digest": "40750837c2d462bb2a8fc25f9cf5ed46e48284df93298a1e59f591dff8672f10",
                "owned": [
                    "sim_fixture/pedestal",
                    "sim_fixture/qualification_cube",
                    "sim_fixture/place_pedestal",
                ],
                "fd": "429477b1ca6a53bed6f2ff2a32d62ee6b53fe6e80a319d978c2f98868c1c5788",
                "target": "sim_fixture/qualification_cube",
            },
            "qualification-pick-place-blocked-approach": {
                "decl": "e762995b84849d7d3f37aa5d7d2e4e6588ea6e8a58a4e6c110aafc518f660fbe",
                "rev": "qualification-v1",
                "rev_digest": "39c5111513a60add004ce1fd81567ce0fde2bbf2593771c94658133828c9ce15",
                "owned": [
                    "sim_fixture/pedestal",
                    "sim_fixture/qualification_cube",
                    "sim_fixture/place_pedestal",
                ...
                "fd": "1ac01785ef9040ddf7df18f4010efb338f2366ba30e9ac7b8da8e3d09a098cd7",
                "target": "sim_fixture/qualification_cube",
            },
            "qualification-pick-place-unreachable-grasp": {
                "decl": "a2e0fd2ebfa8f1bc532c361c3c060969a1500be410577604a36a5cd2727c4836",
                "rev": "qualification-v1",
                "rev_digest": "1170d5f11f7c5810cbf506fcd5748c613b1eb5dd7e41bd81d718c4e6cc4295dc",
                "owned": [
                    "sim_fixture/pedestal",
                    "sim_fixture/qualification_cube",
                    "sim_fixture/place_pedestal",
                ],
                "fd": "59b3f965d4e1be3a26910cbf4014e4bc86c1ff1bebee1bf6f167b32583eee8c8",
                "target": "sim_fixture/qualification_cube",
            },
            "qualification-pick-place-malformed-back": {
                "decl": "f1718384f4468ce8f25de0157a54822a732721ef25206e3f496dd8f3549a4a3c",
                "rev": "qualification-v1",
                "rev_digest": "40750837c2d462bb2a8fc25f9cf5ed46e48284df93298a1e59f591dff8672f10",
                "owned": [
                    "sim_fixture/pedestal",
            ...
            "qualification-pick-place-cancel-approach": {
                "decl": "084cc1a1695c280ac3a2bafabd24ced65eff624813746e9e13ace6c7bfb144a6",
                "rev": "qualification-v1",
                "rev_digest": "40750837c2d462bb2a8fc25f9cf5ed46e48284df93298a1e59f591dff8672f10",
                "owned": [
                    "sim_fixture/pedestal",
            ...
            "qualification-pick-place-cancel-transport": {
                "decl": "558ca73d68fda2364242a78a258e5439a34105d818445e5359d1d6f8821fa2e6",
                "rev": "qualification-v1",
                "rev_digest": "40750837c2d462bb2a8fc25f9cf5ed46e48284df93298a1e59f591dff8672f10",
                "owned": [
                    "sim_fixture/pedestal",
            ...
            "qualification-pick-place-safety-transport": {
                "decl": "b74bbc951b28e755af2eee667dcab2c4a92f3e2130537d8a0f5d72245d2623ad",
                "rev": "qualification-v1",
                "rev_digest": "40750837c2d462bb2a8fc25f9cf5ed46e48284df93298a1e59f591dff8672f10",
                "owned": [
                    "sim_fixture/pedestal",
            ...
            "qualification-pick-place-occupied-place": {
                "decl": "75d9d1b0dd3585affb64993f9281df782da0cad4bfde41162c53c1c3040652e6",
                "rev": "qualification-v1",
                "rev_digest": "71ef17e58c7c2cae81e83b406d7e16bfc90c3a8799b4a79aec3d42c158506295",
                "owned": [
                    "sim_fixture/pedestal",
                    "sim_fixture/qualification_cube",
                    "sim_fixture/place_pedestal",
                ...
                "fd": "207a492c0b0b28f754e3b185f2e2b7cfdbb7696ab2b1270512d54a3458146efc",
                "target": "sim_fixture/qualification_cube",
            },
        }
